...
TEST_CASE("ex10", "[Dado sobrecargado]")
{
    CDado d(false);

    SECTION( "Validando Ejecucion de Dado sobrecargado lanzado  1 vez" ) {
        d.resetDado();
        REQUIRE(d+1==1);
    }

    SECTION( "Validando Ejecucion de Dado sobrecargado lanzado  5 veces" ) {
        d.resetDado();
        REQUIRE(d+5==5);
    }
}
